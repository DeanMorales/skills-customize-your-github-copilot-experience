...
Practice fundamental Python programming skills by working with user input, string formatting, arithmetic operations, and conditional logic.
...
#### Description
Write a function called `welcome_message()` that collects information from the user and returns a formatted message.
...
#### Description
Write a function called `add_two_numbers()` that asks the user for two numbers and prints their sum.
